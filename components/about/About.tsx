          ...
          <div className="flex w-full flex-col justify-start pb-4 text-sm md:pb-0 lg:w-3/5 ">
            <div className="p-5 tracking-wider">
              ...
              <p className="mt-4">
                ...
                and committed to crafting solutions that not only meet user
                needs but also leave a lasting impact. I am dedicated to
                creating accessible and efficient products that enhance the
                digital landscape.
              </p>
            </div>
